...
e.exposeInMainWorld("electronAPI", {
	...
	openCharacterEditor: () => t.send("open-character-editor"),
	getCharacterConfig: () => t.invoke("get-character-config"),
	saveCharacterConfig: (e) => t.invoke("save-character-config", e),
	onCharacterConfigUpdated: (e) => t.on("character-config-updated", (t, n) => e(n)),
	...
	deleteBundle: (e) => t.invoke("delete-bundle", e),
